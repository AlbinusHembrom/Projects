...
class ahDog extends AhAnimal {
    // Providing implementation for the abstract method
    public void makeSound() {
        System.out.println("Woof!");
        System.out.println("The Dog is wagging its tails.");
    }
}
class ahBird extends AhAnimal {
    // Providing implementation for the abstract method
    public void makeSound() {
